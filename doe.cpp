#include "../solar-dash/sd_gl.h"
#include "../solar-dash/sd_data.h"
...
public:
    Hex(float radius, const glm::vec3 &color) :
	GLObject(CreateHexagon(radius, color)) { }

    Hex(float radius, const glm::vec3 &color, bool mid) :
	GLObject(CreateCircleData(radius, 6, color)) { }
